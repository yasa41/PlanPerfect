  ...
  return (
    <div className="bg-offwhite min-h-screen w-full font-sans">
      ...
      <div className="max-w-7xl mx-auto bg-white rounded-[32px] shadow-2xl mt-6 mb-12 p-10 overflow-x-auto transition min-h-[320px]">
        {activeTab === "Guest List" && <GuestList guestList={guestList} />}
        {activeTab === "Vendors" && <Vendors vendors={vendors} />}
        {activeTab === "ToDo List" && <ToDoList todos={todos} />}
        {activeTab === "Budget" && <Budget budgets={budget} />}
        {activeTab === "Invites" && <Invites invites={invites} />}
      </div>
    </div>
  );
}
